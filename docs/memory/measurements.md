...
| 2026-09-06 | `renderOffline` of the 16-bar fixture in Node, 48 kHz, 2 channels | **6.6–6.9 s** for 30.000 s of audio (0.22× real time); peak 0.585, rms 0.075; the wav is 5.49 MB | three runs, `node --experimental-strip-types`, node 24.18.0, tone 15.1.22, node-web-audio-api 2.2.0, Apple M3 Pro | `engine`: the M1-03 criterion, and the soundcheck budget in `two-clocks.md` |
